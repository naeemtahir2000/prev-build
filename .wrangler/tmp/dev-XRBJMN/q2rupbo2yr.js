// .wrangler/tmp/bundle-3VzbJk/checked-fetch.js
...
// .wrangler/tmp/pages-maUbB7/bundledWorker-0.7452412808443056.mjs
...
var V = (e, t, a) => (a = e != null ? se(re(e)) : {}, oe(t || !e || !e.__esModule ? H(a, "default", { value: e, enumerable: true }) : a, e));
var g;
var u = T(() => {
  g = { collectedLocales: [] };
});
...
function L(e, { url: t, cookies: a, headers: s, routeDest: r }) {
  switch (e.type) {
    case "host":
...
async function k(e, { request: t, assetsFetcher: a, ctx: s }, { path: r, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = S(await a.fetch(j(c, e.path ?? r))), e.headers && x(n.headers, e.headers);
        break;
      }
      case "static": {
        n = await a.fetch(j(c, r));
        break;
      }
      default:
...
var M = class {
  ...
  checkRouteMatch(t, { checkStatus: a, checkIntercept: s }) {
    ...
    }) && !t.missing?.find((n) => L(n, i).valid) && !(a && t.status !== this.status)) {
      if (s && t.dest) {
  ...
  processMiddlewareResp(t) {
    ...
    if (i) {
      ...
      this.path = h ? `${c}` : c.pathname, R(this.searchParams, c.searchParams), t.headers.delete(r);
    }
  ...
  applyRouteDest(t, a, s) {
    ...
    return R(this.searchParams, w.searchParams), v(this.path) || (this.path = w.pathname), r;
  }
...
// .wrangler/tmp/pages-maUbB7/q2rupbo2yr.js
...
// .wrangler/tmp/bundle-3VzbJk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3VzbJk/middleware-loader.entry.ts
